                ...
                [](InstructionTable& table)
                {
                    table.Add(0x01C05, 0x2, {
                        ...
                        [](CPU& cpu)
                        {
                            ...
                            const int32_t result = static_cast<int32_t>(static_cast<int16_t>(*erd)) * static_cast<int16_t>(*rs);
                            *erd = result;
                ...
                [](InstructionTable& table)
                {
                    table.Add(0x01D05, 0x3, {
                        ...
                        [](CPU& cpu)
                        {
                            ...
                            if (!*rs) { cpu.reg.flags.Z = true; return; }
                            const auto quotient = static_cast<int16_t>(static_cast<int64_t>(static_cast<int32_t>(*erd)) / static_cast<int16_t>
                                (*rs));
                            const auto remainder = static_cast<int16_t>(static_cast<int64_t>(static_cast<int32_t>(*erd)) % static_cast<
                                int16_t>(*rs));

                            *erd = (static_cast<uint32_t>(static_cast<uint16_t>(remainder)) << 16) | static_cast<uint16_t>(quotient);
